...
function setScene(sceneNum) {
    ...
    if (sceneNum == 1) {
        ...
        scene(sceneNum, gat_s, null, path,
            '["A feeling of sadness sets in as you consider your thoughts that Daisy did not truly enjoy the party"]', null, 'next', null, null,);
    } else if (sceneNum==15) {
        ...
        scene(sceneNum, gat_s, null, hall, 
            '["Sadness envelops you as you remember the Daisy of your memories: the kind and understanding Daisy."]', null, 'Beleive that you can fix her...', null, null,);
    } else if (sceneNum==19) {
        scene(sceneNum, null, null, null, 
            '["𝘕𝘦𝘹𝘵 𝘋𝘢𝘺"]', null, 'Next', null, null,);
    } else if (sceneNum==20) {
        scene(sceneNum, gat_h, null, hall, 
            '["Considering Tom\'s behavior yesterday, you begin to grow increasingly worried of being found out. In particular, you worry that your servants will spread word to the press."]', null, 'Relieve them of their responsibilities', 'Ignore the issue and do nothing', null,);
    } else if (sceneNum==21) {
