...
function setScene(sceneNum) {
    ...
    if (sceneNum == 1) {
        ...
        '["Nervously, you greet the Buchanans, welcoming them to the party.\nYour long wait for your love, Daisy Buchanan, to show up to one of your parties has finally ended."]', null, 'Continue talking with Daisy', 'Look at Daisy, but contain your urge to talk with her', null);
    } else if (sceneNum==3) {
