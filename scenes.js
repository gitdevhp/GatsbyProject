...
function setScene(sceneNum) {
    ...
    if (sceneNum == 1) {
        scene(sceneNum, gat_h, null, hall, '["You catch your breath, having hastened yourself to the door to greet two freshly-arrived guests, Tom and Daisy Buchanan."]', null, 'next', null, null,);
    } else if (sceneNum == 2) {
        ...
        scene(sceneNum, gat_n, null, hall, 
            '["You arrive at the front step of the Buchanan Estate, the sweltering heat making you noticably light headed..."]', null, 'Knock on the door, and enter the mansion', null, null,);
    } else if(sceneNum==28) {
